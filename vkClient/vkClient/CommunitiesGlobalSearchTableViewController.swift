...
class CommunitiesGlobalSearchTableViewController: UITableViewController {
    ...
    var globalCommunities = [
        Community("Forbes Top 200", UIImage(named: "forbesclub")),
        Community("Cars", UIImage(named: "auto")),
        Community("Lovely cats", UIImage(named: "podcast")),
        Community("Education", UIImage(named: "education")),
        Community("Banking & Insurance", UIImage(named: "banking")),
        Community("Life", UIImage(named: "life")),
        ...
        Community("Netflix Best", UIImage(named: "N")),
